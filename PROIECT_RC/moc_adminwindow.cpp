...
QT_MOC_LITERAL(5, 50, 6) // "onExit"

    },
    "AdminWindow\0returnToMain\0\0onSendCommand\0"
    "onRefresh\0onExit"
};
...
void AdminWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AdminWindow::returnToMain)) {
                *result = 0;
                return;
            }
        }
